...
public class SyncFragment extends BaseFragment<SyncFragmentBinding> {
    ...
    private void showKeystoneInfo() {
        ModalDialog modalDialog = ModalDialog.newInstance();
        CommonModalBinding binding = DataBindingUtil.inflate(
                LayoutInflater.from(mActivity), R.layout.common_modal,
                null, false);
        binding.title.setText(R.string.export_xpub_guide_text1_keystone);
        binding.subTitle.setText(R.string.export_xpub_guide_text2_keystone_info);
